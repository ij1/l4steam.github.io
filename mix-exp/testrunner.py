...
def CCAFactory(name=None, color=None, aqm=None, ecn=None, ecnopt=-1, ecnunsafe=-1, params=None, extra_rtt=0, superklass=CCA, extra=''):
    ...
    NewCCA.__name__ = '%s%s%s%s%s' % (NewCCA.NAME.capitalize(),
